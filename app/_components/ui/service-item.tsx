...
const getTimeList = (bookings: Booking[]) => {
  return TIME_LIST.filter((time) => {
    ...
    const hasBookingOnCurretTime = bookings.some(
      (booking) =>
        booking.date.getHours() == hour && booking.date.getMinutes() == minutes,
    )
    if (hasBookingOnCurretTime) {
      return false
    }
    return true
  })
            ...
            <div className="flex items-center justify-between">
              ...
              >
                <Button
                  variant="secondary"
                  size="sm"
                  onClick={handleBookingClickCheck}
                >
                  Reservar
                </Button>

                <SheetContent className="ps-14">
                  <SheetHeader>
